...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Save user to Firestore (replaces localStorage)
    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-[#F6F3EC] to-white px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Join the community</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <p className="text-center text-xs text-gray-500 mt-4">
              By signing up you agree to Nook&apos;s{" "}
              <Link href="/terms" className="text-[#6FA8DC] hover:text-[#2F4B7C] font-medium">
                Terms and Service
              </Link>
            </p>
          </form>
